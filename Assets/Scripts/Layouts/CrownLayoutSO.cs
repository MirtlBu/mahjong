...
[CreateAssetMenu(fileName = "CrownLayout", menuName = "Mahjong/Layouts/Crown")]
public class CrownLayoutSO : LayoutSO
{
    public override List<Vector3Int> GetPositions()
    {
        var positions = new List<Vector3Int>();

        // Layer 0 — two hollow rectangles joined at center (53 tiles)
        int[,] layer0 = {
        ...
        // Layer 1 — crown points and center gem (7 tiles)
        int[,] layer1 = {
            {1,0,0,0,1,0,0,0,1},  // y= 8
        ...
        return positions;  // 53 + 7 = 60 tiles
    }
